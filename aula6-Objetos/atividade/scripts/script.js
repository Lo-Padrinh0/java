...
function listarCarro(){
    document.querySelector("#principal").innerHTML = `
        ...
        <input onfcusout="acelerar()" type="number" id="acelerar" min="0" max="${carro.velMax}"placeholder="Insira um valor para acelerar" >
...
function acelerar(){
    let acelerar = document.querySelector("#acelerar").value
